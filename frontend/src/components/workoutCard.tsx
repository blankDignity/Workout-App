...
export function WorkoutCard({workout}: WorkoutCardProps) {
  return (<div className={"flex justify-between items-center bg-[#18181e] hover:bg-[#1e1e26] m-1 rounded-2xl h-25"}>
    <div className={"flex gap-6 items-center"}>
      <svg className={"w-12 h-12 bg-[#ff4757] p-2 rounded-2xl"} fill="white" id="Layer_1" data-name="Layer 1"
           viewBox="0 0 24 24">
        <path
    ...
    <div className={"flex gap-2 -mr-3 text-[#8b8b95] items-center font-medium"}>
