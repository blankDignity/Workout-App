export function Streak() {
  return (<div className={"flex flex-col gap-2 bg-linear-to-br from-[#ff4757] to-[#ff6b81] border rounded-2xl border-transparent p-6 mr-10"}>
        <svg className={"w-15"} fill="#ff4757" viewBox="0 0 64 64" stroke="#ffffff" stroke-width="3">
          <path
        ...
        <div className={"font-bold text-2xl"}>12 Day Streak!</div>
        <div className={"text-zinc-100"}>You are on fire! Keep pushing to reach your 30 day goal.</div>
        <div className={"mt-2 w-full h-3 bg-red-300 rounded"}>
          <div className={"bg-white h-3 rounded"} style={{width: "40%"}}>
          </div>
        </div>
        <div className={"text-[16px] text-zinc-200"}>12 / 30 days</div>
      </div>)
}