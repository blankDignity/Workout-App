...
const navItems: SidebarProps[] = [{id: "home", to: "/", label: "Home", icon: "home.svg"}, {
  id: "addWorkout",
  to: "/addWorkout",
  label: "Add Workout",
  icon: "addWorkout.svg"
}, {id: "workoutPlans", to: "/workoutPlans", label: "Workout Plans", icon: "workoutPlan.svg"}, {
  id: "about",
  to: "/about",
  label: "About",
  icon: "about.svg"
...
function Sidebar() {
  return (<aside className="w-60 h-screen">
